...
const MathematicsModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className="math-modal-overlay modal_popup_mathematics"
      onClick={onClose}
    >
      <div
        className="math-modal-content common-modal-content"
        onClick={(e) => e.stopPropagation()}
      >
        <button
          className="math-modal-close common-modal-close"
          onClick={onClose}
        >
          ×
        </button>
        <div className="math-modal-body common-modal-body">
          <div className="math-modal-text">
            <h2>Mathematics And LLMs</h2>
            <p>
              In Partnership With Prof. Dr. Siddhartha Gadgil, Indian Institute
              Of Science, We're Developing An AI-Driven LLM That Rigorously
